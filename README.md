...
- **多渠道翻译 + 自动回退**：MyMemory（免费免 key）→ DeepSeek → Bing（Edge 免费模式，可选 Azure 官方）→ 腾讯云 TMT → 自定义 OpenAI 兼容渠道；失败按配置顺序自动回退，429 限流指数退避
...
- 翻译文本会发送至所选第三方服务（MyMemory/Bing/DeepSeek/腾讯云 TMT/自定义）
